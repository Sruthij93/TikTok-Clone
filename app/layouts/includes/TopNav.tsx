          ...
          <div className="relative hidden md:flex items-center justify-end bg-[#F1F1F2] p-1 rounded-full max-w-[430px] w-full">
            ...
            <div className="absolute bg-white max-w-[910px] h-auto w-full z-20 left-0 top-12 border p-1">
              <div className="p-1">
                <Link
                  href={`/profile/1`}
                  className="flex items-center justify-between w-full cursor-pointer hover:bg-pink-600 p-1 px-2 hover:text-white"
                >
                  <div className="flex item-center">
                    ...
                    />
                    <div className="truncate ml-2">User Name</div>
                  </div>
                </Link>
              </div>
            </div>
          ...
          <div className="flex items-center gap-3">
            ...
            {true ? (
              <div className="flex items-center">
                <button className="flex items-center bg-pink-500 text-white border rounded-md px-3 py-[6px]">
